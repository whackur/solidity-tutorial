...
contract Q22SpotPriceBasicLab is SolvableBase {
    ...
    mapping(address => Q22MockPool) public poolOf;
    ...
    function createInstance() external returns (address pool) {
        ...
        Q22MockPool p = new Q22MockPool(INITIAL_RESERVE, INITIAL_RESERVE, msg.sender);
        poolOf[msg.sender] = p;
