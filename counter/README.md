...
> Entry-level contracts for lecture chapter *2-2 (Solidity dev environment & basic contract code)*.
...
- Read the same selector lookup that try/catch dispatch uses (links to lecture chapter 1-3).
